...
type BankReportRow = { banco: string; count: number; total: number };
...
export default function ReportByBank({ reporte, totalValorFiltrado }: Props) {
    return (
                        ...
                        {reporte.length === 0 && (
                            <tr>
                                <td colSpan={3} style={{ padding: 16, color: "#64748b", fontWeight: 900 }}>
                                    Sin datos para reporte con los filtros actuales.
                                </td>
                            </tr>
                        )}
                    </tbody>
